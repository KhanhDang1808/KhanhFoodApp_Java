package com.example.food.View.Bill;
...
import com.example.food.Presenter.GioHangPreSenter;
import com.example.food.Presenter.GioHangView;
...
//Dien thong tin đặt hàng
    ...
    private void requestPayment() {
        ...
        eventValue.put("merchantname", "Khanh Food"); //Tên đối tác. được đăng ký tại https://business.momo.vn. VD: Google, Apple, Tiki , CGV Cinemas
